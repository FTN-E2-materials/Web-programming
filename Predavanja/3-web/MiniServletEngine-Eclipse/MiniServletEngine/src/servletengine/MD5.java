...
public class MD5 {
    ...
    public static void main (String[] args){
        try {
          if (args.length < 2){
              System.err.println("Enter username and password.");
          } else {
//            PrintWriter pw = new PrintWriter (new OutputStreamWriter(new FileOutputStream("acl.conf", true)));
//            pw.println(args[0] + "=" + MD5.getHashString(args[1] + ":" + args[0] + ":" + args[2]));
            System.out.println(args[0] + "=" + MD5.getHashString(args[1] + ":" + args[0] + ":" + args[2]));
//            pw.close();
          }
        } catch (Exception ex) {
          ex.printStackTrace();
