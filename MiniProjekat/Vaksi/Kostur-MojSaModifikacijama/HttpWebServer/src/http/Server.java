...
public class Server {
	...
	private List<User> pacijenti;
	private UserDAO usersDAO;
	
	public Server(int port) throws IOException {
		this.port = port;
		this.serverSocket = new ServerSocket(this.port);
		this.pacijenti = new ArrayList<User>();
		this.usersDAO = new UserDAO("nije-pravi-link-samo-bzv-konstruktor-zbog-mokapa");
